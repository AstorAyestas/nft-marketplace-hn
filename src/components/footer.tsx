  ...
  return (
    <footer className="bg-gradient-to-r from-[#accbee] to-[#e7f0fd] px-4 py-4 text-slate-600">
      ...
      <p className="font text-justify leading-6">
        ...
        conocimiento e incentivar la investigación en torno a las tecnologías de
        la industria del Blockchain de forma práctica.
      </p>
      <div className="flex items-center space-x-2">
        ...
        <a
          className=""
          target="_blank"
          href="https://github.com/AstorAyestas/nft-marketplace-hn"
